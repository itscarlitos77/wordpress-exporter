...
func (c *WordpressCollector) Collect(ch chan<- prometheus.Metric) {
	...
	c.Wp.categories, err = CountJSONItems(c.FetchJSONFromEndpoint("/index.php?rest_route=/wp/v2/categories"))
	ErrCheck(err)
	c.Wp.posts, err = CountJSONItems(c.FetchJSONFromEndpoint("/index.php?rest_route=/wp/v2/posts"))
	ErrCheck(err)
	c.Wp.tags, err = CountJSONItems(c.FetchJSONFromEndpoint("/index.php?rest_route=/wp/v2/tags"))
	ErrCheck(err)
	c.Wp.pages, err = CountJSONItems(c.FetchJSONFromEndpoint("/index.php?rest_route=/wp/v2/pages"))
	ErrCheck(err)
	c.Wp.comments, err = CountJSONItems(c.FetchJSONFromEndpoint("/index.php?rest_route=/wp/v2/comments"))
	ErrCheck(err)
	c.Wp.media, err = CountJSONItems(c.FetchJSONFromEndpoint("/index.php?rest_route=/wp/v2/media"))
	ErrCheck(err)
	c.Wp.users, err = CountJSONItems(c.FetchJSONFromEndpoint("/index.php?rest_route=/wp/v2/users"))
	ErrCheck(err)
	c.Wp.taxonomies, err = CountJSONItems(c.FetchJSONFromEndpoint("/index.php?rest_route=/wp/v2/taxonomies"))
	ErrCheck(err)
	c.Wp.themes, err = CountJSONItems(c.FetchJSONFromEndpoint("/index.php?rest_route=/wp/v2/themes"))
	ErrCheck(err)
	c.Wp.plugins, err = CountJSONItems(c.FetchJSONFromEndpoint("/index.php?rest_route=/wp/v2/plugins"))
	ErrCheck(err)
